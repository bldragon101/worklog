...
describe("JobForm Multi-Select Functionality", () => {
  ...
  describe("Form Submission", () => {
    it("form data conversion logic works correctly", () => {
      ...
      expect(arrayToString(["Melbourne", "Richmond"])).toBe(
        "Melbourne, Richmond",
      );
    ...
    it("string to array conversion logic works correctly", () => {
      ...
      // Test different scenarios
      expect(stringToArray("Melbourne, Richmond")).toEqual([
        "Melbourne",
        "Richmond",
      ]);
  ...
  describe("Edge Cases", () => {
    it("handles malformed comma-separated strings in conversion logic", () => {
      ...
      expect(stringToArray("  Melbourne,  ,Richmond, , Fitzroy  ")).toEqual([
        "Melbourne",
        "Richmond",
        "Fitzroy",
      ]);
      expect(stringToArray(",Carlton,,Collingwood,")).toEqual([
        "Carlton",
        "Collingwood",
      ]);
      expect(stringToArray(",,,,")).toEqual([]);
