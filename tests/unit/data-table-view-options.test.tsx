...
describe("DataTableViewOptions", () => {
  ...
  it("renders the view button", () => {
    ...
    expect(viewButton).toHaveAttribute("id", "view-columns-btn");
    // Check that it contains the mixer icon
    expect(
      viewButton.querySelector('[data-testid="mixer-icon"]'),
    ).toBeInTheDocument();
  });
  ...
  it("shows correct initial checkbox states", () => {
    ...
    const col1Item = screen
      .getByText("col1")
      .closest('[data-testid="dropdown-checkbox-item"]');
    const col2Item = screen
      .getByText("col2")
      .closest('[data-testid="dropdown-checkbox-item"]');
    const col3Item = screen
      .getByText("col3")
      .closest('[data-testid="dropdown-checkbox-item"]');
