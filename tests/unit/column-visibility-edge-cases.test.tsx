...
describe("Column Visibility Edge Cases", () => {
  ...
  it("handles rapid successive clicks without state corruption", () => {
    ...
    const viewButton = screen.getByRole("button", { name: /view columns/i });
  ...
  it("handles columns without IDs gracefully", () => {
    ...
    const validColumn = checkboxItems.find(
      (item) => item.textContent === "valid",
    );
  ...
  it("maintains state consistency when table instance changes", () => {
    ...
    const updatedCol2Checkbox = screen.getByRole("menuitemcheckbox", {
      name: "col2",
    });
  ...
  it("handles columns with special characters in IDs", () => {
    ...
    const dashCheckbox = screen.getByRole("menuitemcheckbox", {
      name: "col-with-dashes",
    });
  ...
  it("handles very large column visibility states", () => {
    ...
    const firstCheckbox = screen.getByRole("menuitemcheckbox", {
      name: "col0",
    });
