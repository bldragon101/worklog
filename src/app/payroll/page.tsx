  ...
  return (
    <ProtectedLayout>
      <ProtectedRoute
        ...
        fallbackTitle="Payroll Access Required"
        fallbackDescription="You need payroll management permission to access this page. Only administrators can manage payroll."
      >
        <div className="flex flex-col h-full space-y-6 p-6">
          <PageHeader pageType="payroll" />
