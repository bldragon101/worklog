      ...
      <div className="flex flex-col h-full space-y-6">
        <header className="mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-2">Maintenance</h1>
              <p className="text-gray-500 dark:text-gray-400 text-sm sm:text-base">Track vehicle maintenance schedules and service history.</p>
            </div>
          </div>
        </header>
