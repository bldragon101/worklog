      ...
      <div className="flex flex-col h-full space-y-6">
        <header className="mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-2">Permissions</h1>
              <p className="text-gray-500 dark:text-gray-400 text-sm sm:text-base">Configure user roles and permissions.</p>
            </div>
          </div>
        </header>
        ...
        <Card className="border-2 border-dashed border-yellow-300 dark:border-yellow-600 bg-yellow-50 dark:bg-yellow-900/20">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-yellow-700 dark:text-yellow-300">
              Permissions module is currently under development
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            ...
            <div className="text-sm text-yellow-600 dark:text-yellow-400 space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-left max-w-md mx-auto">
                ...
                <li>Audit logging for permissions</li>
