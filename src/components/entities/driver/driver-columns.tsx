...
export const driverColumns = (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const typeVariant = row.original.type === "Employee" ? "default" : 
                         row.original.type === "Contractor" ? "secondary" : "outline";
      return (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      if (row.original.type !== "Subcontractor") {
        return <div className="font-mono text-s text-muted-foreground">N/A</div>;
      }
      return (
